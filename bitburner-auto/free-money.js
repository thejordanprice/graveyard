            ...
            if (allData.length > 0 && allData[0] instanceof Uint8Array) {
                ...
                try {
                    ...
                    try {
                        ...
                        // Modify the money
                        jsonData.data.PlayerSave = JSON.parse(jsonData.data.PlayerSave); // Parse nested PlayerSave
                        jsonData.data.PlayerSave.data.money += 1e12; // Add 1 trillion dollars
                        jsonData.data.PlayerSave = JSON.stringify(jsonData.data.PlayerSave); // Re-stringify PlayerSave
